    ...
    public partial class MainWindow : Window
    {
        ...
        private void stop()
        {
               ...
               (Button3.Content == "✕" && Button6.Content == "✕" && Button9.Content == "✕") ||(Button3.Content == "✕" && Button5.Content == "✕" && Button7.Content == "✕"))
            {
                ...
                WinnerOutput.Content = "Плюсек выиграл";
            }
               ...
               (Button3.Content == "◯" && Button6.Content == "◯" && Button9.Content == "◯") ||(Button3.Content == "◯" && Button5.Content == "◯" && Button7.Content == "◯"))
            {
                ...
                WinnerOutput.Content = "Буква ноль выиграл";
            }
            if ((Button1.Content != "" && Button2.Content != "" && Button3.Content != "" && Button4.Content != "" && Button5.Content != "" && Button6.Content != "" && Button7.Content != "" && Button8.Content != "" && Button9.Content != ""))
            {
                ...
                WinnerOutput.Content = "Вроде бы ничья";
            }
        }
        ...
        private void Start_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (Controls.isx) XOChange.Content = "Chsd O";
            else XOChange.Content = "Chsd X";
        }
        ...
        private void xochange(object sender, RoutedEventArgs e)
        {
            if (Controls.isx)
            {
                Controls.isx = false; 
